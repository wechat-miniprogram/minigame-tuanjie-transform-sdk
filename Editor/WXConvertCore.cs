...
namespace WeChatWASM
{
    public class WXConvertCore
    {
        ...
        public static bool UseIL2CPP => PlayerSettings.GetScriptingBackend(BuildTargetGroup.WeixinMiniGame) == ScriptingImplementation.IL2CPP;
...
GameGlobal.unityNamespace.UnityModule = unityFramework;";
        ...
        private static void ConvertCode()
        {
           ...
           string[] prefixs =
            ...
            var header = @"function createWebAudio() {
...
";
            ...
            File.WriteAllText(Path.Combine(config.ProjectConf.DST, miniGameDir, frameworkDir, target), text, new UTF8Encoding(false));
