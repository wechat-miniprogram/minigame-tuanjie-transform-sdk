// @ts-nocheck
// Worker 侧 worker-channel —— 与 unity-sdk/worker-channel.ts 保持同步
...
export class WorkerChannel {
    ...
    /**
     * Worker 端初始化：接管 SAB + 启动轮询 + 监听 onMessage。
     * dispatchFn({ type, payload }) 由调用方提供；INIT_CONFIG 直接以 payload 对象传入。
     */
