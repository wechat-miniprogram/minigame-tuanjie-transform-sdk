...
GameGlobal.WXGameKit.gameInstance = GameGlobal.WXGameKit.gameInstance || {};

window._ScaleRate = 1;

const engine = WXGameKit.config.project.engine;
if (engine && engine.name == 'Unity' && engine.version.split('.').slice(0, 2)
  .join('') < '20193') {
