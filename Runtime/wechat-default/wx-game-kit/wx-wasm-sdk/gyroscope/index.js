...
const OnGyroscopeChange = (res) => {
    ...
    WXGameKit.loader.module.dynCall_viii(wxOnGyroscopeChangeCallback, xPtr, yPtr, zPtr);
    WXGameKit.loader.module._free(xPtr);
    WXGameKit.loader.module._free(yPtr);
    WXGameKit.loader.module._free(zPtr);
};
function handleCallback(callback, id, callbackType, res) {
    ...
    WXGameKit.loader.module.dynCall_viii(callback, idPtr, callbackType, msgPtr);
    WXGameKit.loader.module._free(idPtr);
    WXGameKit.loader.module._free(msgPtr);
}
