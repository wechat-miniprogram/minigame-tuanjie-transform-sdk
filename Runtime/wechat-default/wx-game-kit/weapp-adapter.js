// @ts-nocheck
import { formatIdentifier } from './wx-wasm-sdk/utils';
//import { formatIdentifier } from './index';
...
/** ****/ (function (modules) {
  ...
  /** ****/
    ...
    const clientPerfAdapter = Object.assign({}, {
      now: function now() {
        if (GameGlobal.WXGameKit.gameInstance.isDevelopmentBuild
          && GameGlobal.WXGameKit.gameInstance.isProfilingBuild
          && !GameGlobal.WXGameKit.gameInstance.env.isDevtools
    ...
    function touchEventHandlerFactory(type) {
      return function (event) {
        ...
        touchEvent.timeStamp = Date.now();
        touchEvent._nativeTimeStamp = event.timeStamp;
